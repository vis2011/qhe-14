...
var ddr;
var dd_running , dr ,l1 ,l2, d_running , ideal ,wallimg ,wall , clueobject1 , opt1 , opt2 ,opt3 ,opt1img , opt2img ,opt3img;
...
function setup() {
  ...
  l1 = createImg("heart1.png");
  l1.position(windowWidth/2 + 600 , 60 );
    l1.hide();
  

  l2 = createImg("heart2.png");
  l2.position(windowWidth/2 + 600 , 60 );
  l2.hide();
